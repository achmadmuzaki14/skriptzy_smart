                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    ...
                                    <p class="mb-0">OR Sign in with existing account</p>
                                    ...
                                    <form role="form" class="text-start" method="POST" action="sign-in">
                                        ...
                                        <div class="mb-3">
                                            <input type="email" id="email" name="email" class="form-control"
                                                ...
                                                value="{{ old('email') ? old('email') : 'admin@pembimbing.com' }}"
                            ...
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    ...
                                    <div
                                        ...
                                        <h2 class="mt-3 text-dark font-weight-bold">We Assist You in Choosing the Best, for a Bright Future!</h2>
                                        <h6 class="text-dark text-sm mt-5">Sistem Pendukung Keputusan Pemilihan Mahasiswa Terbaik Komunitas Akademik</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
